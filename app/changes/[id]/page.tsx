...
export default function ChangeDetailPage() {
  ...
  if (loading) {
    return <p className="text-gray-400 py-20 text-center">Loading change request...</p>
  }

  if (!change) {
    return <p className="text-gray-400 py-20 text-center">Change request not found.</p>
  }
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-8">
      ...
      <div className="bg-white rounded-2xl border border-gray-200 p-6 mb-5">
        ...
        {/* Action buttons for agents and admins */}
